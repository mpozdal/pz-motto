...
import { listOrders, listRoles, listStores } from "../graphql/queries";
import { createUser, updateOrder } from "../graphql/mutations";
...
export default function UserCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setDefaultStore(initialValues.defaultStore);
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          const modelFieldsToSave = {
            ...
            userDefaultStoreId: modelFields?.defaultStore?.id,
            userRoleId: modelFields?.role?.id,
          };
          const user = (
            await client.graphql({
