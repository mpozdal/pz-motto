...
import { listDrinks, listOrderItems } from "../graphql/queries";
import { createFlavorShot } from "../graphql/mutations";
...
export default function FlavorShotCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setOrderItemFlavorShotsId(initialValues.orderItemFlavorShotsId);
    setCurrentOrderItemFlavorShotsIdValue(undefined);
    setCurrentOrderItemFlavorShotsIdDisplayValue("");
    setDrinkFlavorShotsId(initialValues.drinkFlavorShotsId);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createFlavorShot.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "FlavorShotCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
