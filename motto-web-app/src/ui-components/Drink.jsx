...
export default function Drink(props) {
  ...
  const resetStateValues = () => {
    ...
    setMilks(initialValues.milks);
    setCurrentMilksValue(undefined);
    setCurrentMilksDisplayValue("");
    setCategoryDrinksId(initialValues.categoryDrinksId);
  ...
  return (
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          const modelFieldsToSave = {
            ...
            categoryDrinksId: modelFields.categoryDrinksId,
          };
          const drink = (
            await client.graphql({
              query: createDrink.replaceAll("__typename", ""),
              variables: {
                input: {
                  ...modelFieldsToSave,
                },
          ...
          const promises = [];
          promises.push(
            ...sizes.reduce((promises, original) => {
              promises.push(
                client.graphql({
          ...
          promises.push(
            ...milks.reduce((promises, original) => {
              promises.push(
                client.graphql({
    ...
    >
      ...
      <SelectField
        ...
        onBlur={() => runValidationTasks("Milk", Milk)}
      ...
      >
        <option
          children=""
          value=""
          {...getOverrideProps(overrides, "Milkoption0")}
        ></option>
        <option
          children=""
          value=""
          {...getOverrideProps(overrides, "Milkoption1")}
        ></option>
      </SelectField>
      <ArrayField
